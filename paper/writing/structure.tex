...
\begin{enumerate}
	...
	\item\label{item_2} \textbf{Measuring Tone} After assigning a topic to each article (document), a dictionary-based sentiment analysis is conducted to estimate how topics are discussed differently by different news wires.
...
\begin{figure}[H]
	\caption{Sentiment Score by news wire}
		\begin{center}
			\includegraphics[width=0.9\textwidth,keepaspectratio]{../figs/sentscore_site.png}
		\end{center}
	\label{fig_sentscore_site}
\end{figure}

\begin{figure}[H]
	\caption{Sentiment Score Radarplot}
		\begin{center}
			\includegraphics[width=0.9\textwidth,keepaspectratio]{../figs/sentscore_radar.png}
		\end{center}
