...
This process revealed that a model with 50 topics best reflects the structure in the corpus. Furthermore, the media outlet of the article is used as covariates in the topic prevalence and topical content. In other words, the corresponding newswire of an article influences the probability distribution of topics and how the topics are discussed. To address problems due to non-convexity, we rely on the spectral initialization approach advocated by \citet{roberts_navigating_2016}. 
...
We will select the following topics from the whole set (topics are ordered regarding their overall corpus frequency). The most frequent words of these topics can be seen in the appendix \ref{fig_plotquote}:
...
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote1.png}
	\caption{}
\end{figure}
	
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote2.png}
	\caption{}
\end{figure}
	% 4
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote4.png}
	\caption{}
\end{figure}

	% 10
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote10.png}
	\caption{}
\end{figure}

	% 13
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote13.png}
	\caption{}
\end{figure}
	% 17
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote17.png}
	\caption{}
\end{figure}

	% 20
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote20.png}
	\caption{}
\end{figure}
	% 23
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote23.png}
	\caption{}
\end{figure}
	% 26
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote26.png}
	\caption{}
\end{figure}
	% 27
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote27.png}
	\caption{}
\end{figure}
	% 30
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote30.png}
	\caption{}
\end{figure}
	% 32
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote32.png}
	\caption{}
\end{figure}
	% 37
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote37.png}
	\caption{}
\end{figure}
	% 46
\begin{figure}[H]
	\includegraphics[width=.49\textwidth]{../figs/plotquote46.png}
	\caption{}
\end{figure}
