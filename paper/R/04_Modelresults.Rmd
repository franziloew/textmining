...
sagelabs$cov.betas[[3]]$problabels[,1:5]
```

```{r}
topics <- matrix(c(1, "SPD, M.Schulz", 2, "A.Merkel vs. Schulz", 3, "B90/Die Grüne, coalition talks", 4, "EU policies", 
                   5, "H.Kohl", 6, "A.Merkel", 7, "Federal Election results", 8, "CSU, Seehofer, Söder", 
                   9, "Welt, Deutschland, Menschen", 10, "Parliament (Bundestag)", 
                   11, "W.Schäuble", 12, "Refugees in GER", 13, "G.Schröder, IT Topics", 
                   14, "B90/Die Grüne, climate/refugee policy", 
                   15, "D.Trump, Israel", 16, "Great coalition", 17, "AfD, in media", 
                   18, "Jamaica coalition", 
                   19, "Rubbish", 20, "Terror attack Amri", 21, "German armed forces, Mali, Helicopter", 
                   22, "Muslim, Ditib", 23, "Elections in Niedersachsen", 24, "CDU, Twitter, Saxony", 
                   25, "Europa", 26, "Bundestag, Laws", 
                   ...
                   34, "Left- & Right-wing Terror", 35, "CDU/CSU H.Seehofer, Obergrenze",
                   36, "Church", 37, "Car industry, Stuttgart", 38, "AfD, F.Petry", 39, "Statistics, welfare policy",
...
1, "SPD, M.Schulz"
2, "A.Merkel vs. Schulz"
3, "B90/Die Grüne, coalition talks"
4, "EU policies"
5, "H.Kohl", 
6, "A.Merkel", 
8, "CSU, Seehofer, Söder",
...
35, "CDU/CSU H.Seehofer, Obergrenze",
38, "AfD, F.Petry")
