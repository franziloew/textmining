...
```{r}
df_full <- bind_rows(list(okt,nov_03,nov_22,dec_16)) %>%
  mutate(text = body,
         # Extract site 
...
df_full %>%
  ...
  filter(date>=as.Date("2017-09-14")) -> btw
```
...
clean.text <- function(x)
  ...
  x = gsub("im Gespräch mit \\w{1,}", "", x, ignore.case = TRUE)
  x = gsub("Heinlein", "", x, ignore.case = TRUE)
  x = gsub("Barenberg", "", x, ignore.case = TRUE)
  x = gsub("Büüsker", "", x, ignore.case = TRUE)
  x = gsub("Dobovisek", "", x, ignore.case = TRUE)
  x = gsub("Schmidt-Mattern", "", x, ignore.case = TRUE)
  x = gsub("Zagatta", "", x, ignore.case = TRUE)
  x = gsub("Armbrüster", "", x, ignore.case = TRUE)
  x = gsub("Münchenberg", "", x, ignore.case = TRUE)
  x = gsub("Heckmann", "", x, ignore.case = TRUE)
...
```{r}
save(btw, file="../output/btw_combined_small.Rda")
```
