...
```{r}
mystopwords <- c("ich","sie","passwort","uhr","bitte","videolänge","dass","mindestens","das","mail","die","zdf","schon","die","neuer abschnitt", "datenschutzerklärung","premium","nutzungsbedingungen","pflichtfelder","registrierung","anzeige","großbuchstaben","sonderzeichen","html","seitennavigation","swr","fullscreen","wochit","statista","club","sagte","mehr")
