...
ggsave(filename = "../figs/topic_proportion.png")
```
...
ggsave(filename = "../figs/sentscore_monthly.png", plot = p2, width = 12)
```
...
ggsave(filename = "../figs/sentscore_site.png", plot = p2, width = 12)
```
...
ggsave(filename = "../figs/sentscore_radar.png", plot = p, width = 12)
```
...
polls_monthly %>%
  ...
  geom_line() +
  scale_color_manual(values = c("skyblue", "gold", "limegreen", "red", "black")) +
...
group1 %>%
  ...
  spread(topic_name, sentiment_n)  -> corr1
