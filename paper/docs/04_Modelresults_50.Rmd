...
print(xtable(coeff_tab[1:56,], type="latex"), file="../writing/tables/coeff1.tex" )
print(xtable(coeff_tab[57:nrow(coeff_tab),], type="latex"), file="../writing/tables/coeff2.tex" )
```
...
p1 <- ggplot(p, 
       aes(yearmonth, sentiment_w, 
           group = topic_name,
           label = obs)) +
  facet_wrap(~topic_name, nrow = 3, labeller=labeller(topic_name = linebreak)) +
  geom_col(fill = col[3], alpha = 0.8) +
...
ggsave(filename = "../figs/sentscore_radar.png", width = 9,
       height = 7,
       plot = p)
```
